...
function renderFeaturedQuest() {
  ...
  title.textContent = featuredMission.title;
  summary.textContent = featuredMission.summary;
  minutes.textContent = `${featuredMission.minutes}분`;
  level.textContent = featuredMission.level;
}
